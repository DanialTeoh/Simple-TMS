 ...
 */
class getRujukanRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RujukanRepository' shared autowired service.
     *
     * @return \App\Repository\RujukanRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RujukanRepository.php';

        return $container->privates['App\\Repository\\RujukanRepository'] = new \App\Repository\RujukanRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
