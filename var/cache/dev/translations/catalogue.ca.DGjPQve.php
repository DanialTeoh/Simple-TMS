...
$catalogue = new MessageCatalogue('ca', array (
  ...
  array (
    ...
    '%count% hour|%count% hours' => '%count% hora|%count% hores',
    '%count% minute|%count% minutes' => '%count% minut|%count% minuts',
    'There was a problem validating your password reset request' => 'S\'ha produït un problema en validar la vostra sol·licitud de restabliment de la contrasenya',
    'There was a problem handling your password reset request' => 'S\'ha produït un problema en gestionar la vostra sol·licitud de restabliment de la contrasenya',
    'The link in your email is expired. Please try to reset your password again.' => 'L\'enllaç del vostre correu electrònic ha caducat. Si us plau, proveu de restablir la contrasenya de nou.',
    'Please update the request_password_repository configuration in config/packages/reset_password.yaml to point to your "request password repository" service.' => 'Actualitzeu la configuració request_password_repository a config/packages/reset_password.yaml per apuntar al vostre servei "repositori de sol·licitud de restabliment de la contrasenya".',
    'The reset password link is invalid. Please try to reset your password again.' => 'L\'enllaç de restabliment de la contrasenya no és vàlid. Si us plau, proveu de restablir la contrasenya de nou.',
    'You have already requested a reset password email. Please check your email or try again soon.' => 'Ja heu sol·licitat un correu electrònic de restabliment de la contrasenya. Si us plau, comproveu el vostre correu electrònic o torneu-ho a provar aviat.',
  ),
));
