...
$catalogue = new MessageCatalogue('el', array (
  ...
  array (
    ...
    '%count% hour|%count% hours' => '%count% ώρα|%count% ώρες',
    '%count% minute|%count% minutes' => '%count% λεπτό|%count% λεπτά',
    'There was a problem validating your password reset request' => 'Παρουσιάστηκε πρόβλημα κατά την επαλήθευση του αιτήματος επαναφοράς του κωδικού πρόσβασής σας',
    'There was a problem handling your password reset request' => 'Παρουσιάστηκε πρόβλημα με τον χειρισμό του αιτήματος επαναφοράς του κωδικού πρόσβασής σας',
    'The link in your email is expired. Please try to reset your password again.' => 'Ο σύνδεσμος στο email σας έχει λήξει. Δοκιμάστε να επαναφέρετε τον κωδικό πρόσβασής σας ξανά.',
    'Please update the request_password_repository configuration in config/packages/reset_password.yaml to point to your "request password repository" service.' => 'Ενημερώστε τη διαμόρφωση request_password_repository στο config/packages/reset_password.yaml για να οδηγεί στην υπηρεσία "request password repository".',
    'The reset password link is invalid. Please try to reset your password again.' => 'Ο σύνδεσμος επαναφοράς κωδικού πρόσβασης δεν είναι έγκυρος. Δοκιμάστε να επαναφέρετε τον κωδικό πρόσβασής σας ξανά.',
    'You have already requested a reset password email. Please check your email or try again soon.' => 'Έχετε ήδη ζητήσει email επαναφοράς κωδικού πρόσβασης. Ελέγξτε το email σας ή δοκιμάστε ξανά σύντομα.',
  ),
));
