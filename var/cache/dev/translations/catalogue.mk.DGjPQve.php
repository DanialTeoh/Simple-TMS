...
$catalogue = new MessageCatalogue('mk', array (
  ...
  array (
    ...
    '%count% hour|%count% hours' => '%count% час|%count% часови',
    '%count% minute|%count% minutes' => '%count% минута|%count% минути',
    'There was a problem validating your password reset request' => 'Настана проблем при верификацијата на барањето за ресетирање на лозинката',
    'There was a problem handling your password reset request' => 'Настана проблем при справувањето со барањето за ресетирање лозинка',
    'The link in your email is expired. Please try to reset your password again.' => 'Врската во вашата е-пошта е истечена. Обидете се повторно да ја ресетирате лозинката.',
    'Please update the request_password_repository configuration in config/packages/reset_password.yaml to point to your "request password repository" service.' => 'Ажурирајте ја конфигурацијата на request_password_repository опциијата во config/packages/reset_password.yaml за да покажува кон вашиот сервис "request password repository".',
    'The reset password link is invalid. Please try to reset your password again.' => 'Врската за ресетирање на лозинката е невалидна. Обидете се повторно да ја ресетирате лозинката.',
    'You have already requested a reset password email. Please check your email or try again soon.' => 'Веќе побаравте да ви биде испратена порака во електронската пошта за ресетирање на лозинката. Проверете ја вашата е-пошта или обидете се повторно наскоро.',
  ),
));
