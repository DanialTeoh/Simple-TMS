 ...
 */
class getFlagRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FlagRepository' shared autowired service.
     *
     * @return \App\Repository\FlagRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FlagRepository.php';

        return $container->privates['App\\Repository\\FlagRepository'] = new \App\Repository\FlagRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
